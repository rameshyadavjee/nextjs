...
export default function Home() {
  return (
    <>
      ...
      <Script src="/public/assets/vendor/glightbox/js/glightbox.min.js" />
      <Script src="/public/assets/vendor/isotope-layout/isotope.pkgd.min.js" />
      <Script src="/public/assets/vendor/swiper/swiper-bundle.min.js" />
      ...
      <section id="topbar" className="d-flex align-items-center">
        <div className="container d-flex justify-content-center justify-content-md-between">
          <div className="contact-info d-flex align-items-center">
            <i className="bi bi-envelope-fill" /><Link href="mailto:contact@example.com">info@example.com</Link>
      ...
      <header id="header" className="d-flex align-items-center">
        <div className="container d-flex align-items-center">
          <h1 className="logo me-auto"><Link href="index.html">Green</Link></h1>
          ...
          <nav id="navbar" className="navbar">
            <ul>
              ...
              <li className="dropdown"><Link href="#"><span>Drop Down</span> <i className="bi bi-chevron-down" /></Link>
                <ul>
              ...
              <div className="row no-gutters">
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="icon-box">
                    ...
                    <h4 className="title"><Link href="#">Dolor Sitema</Link></h4>
                ...
                <div className="col-lg-4 col-md-6">
                  <div className="icon-box">
                    ...
                    <h4 className="title"><Link href="#">Sed ut perspiciatis</Link></h4>
            ...
            <div className="container">
              ...
              <div className="row">
                <div className="col-lg-6 order-1 order-lg-2">
                  <Image src="/assets/img/about.jpg" className="img-fluid" alt="Loreum" width={500} height={500} />
                </div>
                <div className="col-lg-6 pt-4 pt-lg-0 order-2 order-lg-1 content">
                  ...
                  <ul>
                    ...
                    <li><i className="bi bi-check-circled" /> Ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate trideta storacalaperda mastiro dolore eu fugiat nulla pariatur.</li>
                  </ul>
                  <p>
            ...
            <div className="container">
              ...
              <div className="clients-slider swiper">
                <div className="swiper-wrapper align-items-center">
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-1.png" className="img-fluid" width={500} height={500} /></div>
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-2.png" className="img-fluid" width={500} height={500} /></div>
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-3.png" className="img-fluid" width={500} height={500} /></div>
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-4.png" className="img-fluid" width={500} height={500} /></div>
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-5.png" className="img-fluid" width={500} height={500} /></div>
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-6.png" className="img-fluid" width={500} height={500} /></div>
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-7.png" className="img-fluid" width={500} height={500} /></div>
                  <div className="swiper-slide"><Image src="/assets/img/clients/client-8.png" className="img-fluid" width={500} height={500} /></div>
                </div>
              ...
              <div className="row">
                <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                  <div className="member">
                    <Image src="/assets/img/team/team-1.jpg" height={100} width={100} />
                    <h4>Walter White</h4>
                ...
                <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                  <div className="member">
                    <Image src="/assets/img/team/team-2.jpg" height={100} width={100} />
                    <h4>Sarah Jhinson</h4>
                ...
                <div className="col-lg-4 col-md-6 d-flex align-items-stretch">
                  <div className="member">
                    <Image src="/assets/img/team/team-3.jpg" height={100} width={100} />
